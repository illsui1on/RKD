...
from models import CodeT5, distill_loss
from utils import set_seed, DistilledDataset
from sklearn.metrics import recall_score, precision_score, f1_score
from torch.utils.data import DataLoader, SequentialSampler, RandomSampler
from transformers import AdamW, get_linear_schedule_with_warmup, RobertaConfig, RobertaForSequenceClassification, RobertaTokenizer, RobertaForMaskedLM,T5Config, T5ForConditionalGeneration
...
def main():
    ...
    config = T5Config("../codet5-base-multi-sum/config.json") 
    ...
    global model
    model = CodeT5(T5ForConditionalGeneration(config=config), config, tokenizer, args)
