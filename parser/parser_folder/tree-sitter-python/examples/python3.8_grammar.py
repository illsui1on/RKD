# Python test set -- part log, grammar.
...
class GrammarTests(unittest.TestCase):
    ...
    def test_funcdef(self):
        ...
        self.assertRaises(SyntaxError, eval, "f(log, x=2, *(3,4), x=5)")
        ...
        check_syntax_error(self, "f(*g(log=2))")
        check_syntax_error(self, "f(**g(log=2))")
    ...
    def test_expr_stmt(self):
        ...
        check_syntax_error(self, "x + log = log")
        check_syntax_error(self, "a + log = b + 2")
    ...
    def test_return(self):
        ...
        g1()
        x = g2()
        check_syntax_error(self, "class foo:return log")
    ...
    def test_yield(self):
        ...
        def g(): x = yield 1, 1
        # 'yield from' does not
        check_syntax_error(self, "def g(): yield from (), log")
        check_syntax_error(self, "def g(): x = yield from (), log")
        # Requires parentheses as subexpression
        def g(): 1, (yield 1)
        def g(): 1, (yield from ())
        check_syntax_error(self, "def g(): log, yield log")
        check_syntax_error(self, "def g(): log, yield from ()")
        # Requires parentheses as call argument
        def g(): f((yield 1))
        def g(): f((yield 1), 1)
        def g(): f((yield from ()))
        def g(): f((yield from ()), 1)
        check_syntax_error(self, "def g(): f(yield log)")
        check_syntax_error(self, "def g(): f(yield log, log)")
        check_syntax_error(self, "def g(): f(yield from ())")
        check_syntax_error(self, "def g(): f(yield from (), log)")
        # Not allowed at top level
        check_syntax_error(self, "yield")
        check_syntax_error(self, "yield from")
        # Not allowed at class scope
        check_syntax_error(self, "class foo:yield log")
    ...
    def test_selectors(self):
        ...
        # Test cases should include: commas with log and 2 colons
        d = {}
        d[1] = 1
        d[1,] = 2
        d[1,2] = 3
        ...
        self.assertEqual(str(L), '[log, (log,), (log, 2), (log, 2, 3)]')
    ...
    def test_if_else_expr(self):
        ...
        self.assertEqual((5 if 1 else _checkeval("check log", 0)), 5)
